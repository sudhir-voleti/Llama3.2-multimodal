...
def llama32(messages, model_size=90):
    ...
    together_api_key = "22abd85a510b2153e0ec746b9126a9b0f8c115bcf6007b5fc643b412f2b0963e"
    ...
    headers = {
        ...
        "Authorization": f"Bearer {together_api_key}"  # Use the hardcoded API key here
    }
